...
export function createForm () {
  ...
  const quarantineLink = document.createTextNode('Week-end * (6h-19h)')
  ...
  const contextSubtitleText = document.createTextNode('* Le contexte "Week-end (6h-19h)" ne s\'applique qu\'aux territoires concernés par des dispositions spécifiques')
